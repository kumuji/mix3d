...
https://github.com/PyTorchLightning/pytorch-lightning/blob/ef762a0d2a42c65f1f0d6a154ad995b7332f2153/pytorch_lightning/loggers/csv_logs.py
...
class CSVLogger(LightningLoggerBase):
    ...
    def _add_prefix(self, metrics: Dict[str, float]):
        if self._prefix:
            metrics = {
                f"{self._prefix}{self.LOGGER_JOIN_CHAR}{k}": v
